...
# Configuration
PDF_PATH = r"C:\Users\DCL\Downloads\Top 48 CAT Probability, Combinatorics Questions With Video Solutions (1).pdf"
...
def process_pdf_batch(pdf_file, start_q, end_q):
    ...
    prompt = f"""
    You are an expert math teacher. I will provide a PDF containing math questions.
    ...
    6. Classify the subtopic as EXACTLY one of: 'Probability' or 'Permutations-Combinations'.
       - If it involves probability, chance, likelihood -> 'Probability'
       - If it involves arrangements, selections, permutations, combinations -> 'Permutations-Combinations'
    ...
    [
        {{
            ...
            "subtopic": "Probability" | "Permutations-Combinations"
        }}
    ]
...
def upload_questions(questions):
    ...
    for q in questions:
        try:
            ...
            payload = {
                "topic": "Math",
                "subtopic": q.get("subtopic", "Probability"), # Default to Probability if missing
...
def main():
    ...
    total_uploaded = 0
    batch_size = 5
    total_questions = 48 # As per filename
