...
# Configuration
PDF_PATH = r"C:\Users\DCL\Downloads\Top 23 CAT Remainders Questions With Video Solutions.pdf"
...
def process_pdf_batch(pdf_file, start_q, end_q):
    ...
    prompt = f"""
    You are an expert math teacher. I will provide a PDF containing math questions about Remainders.
...
def upload_questions(questions):
    ...
    for q in questions:
        try:
            ...
            payload = {
                "topic": "Math",
                "subtopic": "Remainder Problems", # Hardcoded for this unit
...
def main():
    ...
    total_uploaded = 0
    batch_size = 5
    total_questions = 23 # As per filename
