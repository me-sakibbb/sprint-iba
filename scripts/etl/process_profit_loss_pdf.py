...
PDF_PATH = r"C:\Users\DCL\Downloads\Top 77 CAT Profit, Loss and Interest Questions With Video Solutions.pdf"
...
def process_pdf_batch(pdf_file, start, end):
    ...
    **INSTRUCTIONS:**
    ...
    4.  **Format**: Return a JSON array of objects. Each object must have:
        ...
        - `subtopic`: 'Profit, Loss and Interest'.
...
def main():
    ...
    for start in range(1, total_estimated + 1, batch_size):
        ...
        time.sleep(2) # Reduced wait time with new key
