...
describe('getMotivationalMessage', () => {
  it('should return "Level up! You\'re unstoppable!" when progress is 100', () => {
    expect(getMotivationalMessage(100)).toBe("Level up! You're unstoppable!");
  });

  it('should return "Almost there! One final push!" when progress is between 90 and 99', () => {
  ...
  it('should return "You\'re in the home stretch!" when progress is between 75 and 89', () => {
  ...
  it('should return "Halfway there! Keep the momentum!" when progress is between 50 and 74', () => {
  ...
  it('should return "Great progress! Stay focused!" when progress is between 25 and 49', () => {
  ...
  it('should return "Every sprint starts with a single step!" when progress is below 25', () => {
