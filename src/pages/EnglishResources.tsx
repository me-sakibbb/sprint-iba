    ...
    useEffect(() => {
        const fetchSubtopics = async () => {
            try {
                ...
                let userProgressMap = new Map<string, { isCorrect: boolean }>();
                if (user) {
                    ...
                    if (!progressError && progressData) {
                        progressData.forEach(p => {
                            userProgressMap.set(p.question_id, { isCorrect: p.is_correct });
                        });
                    }
                }
                ...
                if (questionsData) {
                    ...
                    questionsData.forEach(q => {
                        totalQuestions++;
                        // Default subtopic if missing. 
                        // Note: Previous "Question Bank" unit might have had mixed subtopics or null.
                        // We'll treat null as "General" or similar.
                ...
                <div className="border-b border-border/40 bg-background/95 backdrop-blur-xl p-6 z-10">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">English Mastery</h1>
                                ...
                                <>
                                    ...
                                    <div className="grid gap-4">
                                        {selectedUnit.skills.map((skill, index) => (
                                            <Card key={index} className={cn(
                                                "border-border/40 hover:border-green-500/20 transition-colors",
                                                ...
                                                <CardContent className="p-4 flex items-center justify-between">
                                                    ...
                                                    <Button
                                                        ...
                                                        size="sm"
                                                        onClick={() => navigate(`/practice/english/${encodeURIComponent(selectedUnit.id)}/${encodeURIComponent(skill.name)}`)}
                                                    >
                                    ...
                                    <Card className="bg-gradient-to-br from-green-500/5 to-accent/5 border-green-500/20">
                                        <CardContent className="p-6 flex items-center justify-between">
                                            ...
                                            <Button className="bg-green-600 hover:bg-green-700 text-white">Start Test</Button>
                                        </CardContent>
                                    </Card>
                                </>
                            ) : (
